...
| dist                         | 存储客户端代码打包文件  |
| build                        | 存储服务端代码打包文件  |
| src/server.js                | 存储服务器端代码        |
| src/webpack.config.server.js | 服务端 webpack 配置文件 |
| src/webpack.config.client.js | 客户端 webpack 配置文件 |
| src/babel.config.json        | babel 配置文件          |
| src/package.json             | 项目工程文件            |
...
var expensiveCalculation = function (IdleDeadline) {
  // iterationCount大于0并且浏览器空闲时间大于1毫秒
...
<img src="https://raw.githubusercontent.com/xixixiaoyu/CloundImg2/main/image-20220209132733808.png" alt="image-20220209132733808" style="zoom:50%;" />

[React/Fiber 实现 · 云牧](https://gitee.com/z1725163126/example-code/tree/master/React/Fiber)
